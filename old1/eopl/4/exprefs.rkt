...
;
; ExpVal = Number + Boolean + Proc + Ref(ExpVal)
; DenVal = ExpVal
;
...
(define (apply-primitive prim list-of-expval)
  (cases primitive prim
    ...
    (less?-prim ()
      (bool-val (apply < (map expval->num list-of-expval))))
    (newref-prim ()
      (ref-val (apply newref list-of-expval)))
    (deref-prim ()
      (apply deref (map expval->ref list-of-expval)))
    (setref-prim ()
      (apply setref! (expval->ref (car list-of-expval)) (cdr list-of-expval))
      (cadr list-of-expval))))
